  ...
  return (
    <section id="features" className="px-6 py-24">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <p className="text-sm font-medium text-zinc-500 uppercase tracking-wider mb-4">Ревизии</p>
          <h2 className="font-display text-3xl md:text-4xl font-bold text-zinc-100 mb-4">
            Всё для службы и подготовки
          </h2>
          <p className="text-zinc-500 max-w-xl mx-auto text-balance">
            Расписание ревизий, требования к аттестации и инструкции для курсантов и сотрудников.
          </p>
        </motion.div>
            ...
            <Card className="group h-full overflow-hidden border-zinc-800/50 bg-zinc-900/50 hover:border-zinc-700/50 transition-all duration-300 rounded-2xl">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="font-heading font-semibold text-zinc-100">Расписание ревизий</p>
                </div>
                <p className="text-zinc-500 text-sm mb-5">
                  Актуальный график проверок и показатели подготовки личного состава.
                </p>
                <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-4 overflow-hidden">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      >
                        ...
                        <span className="text-xs text-zinc-500">Курсанты</span>
                      </motion.div>
                      <motion.div
                        className="flex items-center gap-1.5"
                        initial={{ opacity: 0 }}
                      ...
                      >
                        ...
                        <span className="text-xs text-zinc-500">Аттестация</span>
                      </motion.div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-3 mb-4">
                    {[
                      { label: "Курсантов", value: "124", change: "+12" },
                      { label: "Аттестовано", value: "98", change: "+8" },
                      { label: "Готовность", value: "92%", change: "+2%" },
                    ].map((metric, i) => (
                      <motion.div
                        key={metric.label}
            ...
            <Card className="group h-full overflow-hidden border-zinc-800/50 bg-zinc-900/50 hover:border-zinc-700/50 transition-all duration-300 rounded-2xl">
              <CardContent className="p-6 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="font-heading font-semibold text-zinc-100">Дисциплина и порядок</p>
                </div>
                <p className="text-zinc-500 text-sm mb-5">Чёткий регламент службы для всего личного состава.</p>
                <div className="mt-auto">
                  <div className="flex items-baseline gap-2 mb-3">
                    ...
                    <span className="text-zinc-500 text-sm">на посту</span>
                  </div>
            ...
            <Card className="group h-full overflow-hidden border-zinc-800/50 bg-zinc-900/50 hover:border-zinc-700/50 transition-all duration-300 rounded-2xl">
              <CardContent className="p-6 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="font-heading font-semibold text-zinc-100">Аттестация</p>
                </div>
                <p className="text-zinc-500 text-sm mb-5">Требования и порядок сдачи нормативов.</p>
            ...
            <Card className="group h-full overflow-hidden border-zinc-800/50 bg-zinc-900/50 hover:border-zinc-700/50 transition-all duration-300 rounded-2xl">
              <CardContent className="p-6 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="font-heading font-semibold text-zinc-100">Инструкции и документы</p>
                </div>
                <p className="text-zinc-500 text-sm mb-5">Регламенты по проведению ревизий и порядку службы.</p>
